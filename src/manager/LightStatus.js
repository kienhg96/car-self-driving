...
const LightStatusFuzzyDepFuncs = [
	LightStatus.Green,
	LightStatus.LessGreen,
	LightStatus.LessRed,
	LightStatus.Red,
	LightStatus.Yellow
];
const LightStatusFuzzySetNames = LightStatusFuzzyDepFuncs.map(function(func) {
	return func.name
});

const LightDistanceFuzzyDepFuncs = [
	LightDistance.Far,
	LightDistance.Medium,
	LightDistance.Near
];
const LightDistanceFuzzySetNames = LightDistanceFuzzyDepFuncs.map(function(func) {
	return func.name
});
